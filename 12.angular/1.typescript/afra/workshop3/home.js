...
var viewprofile = function () {
    console.log("First Name: ".concat(loggedInUser === null || loggedInUser === void 0 ? void 0 : loggedInUser.firstName));
    console.log("Last Name: ".concat(loggedInUser === null || loggedInUser === void 0 ? void 0 : loggedInUser.lastName));
    console.log("Email: ".concat(loggedInUser === null || loggedInUser === void 0 ? void 0 : loggedInUser.email));
    console.log("Phone Number: ".concat(loggedInUser === null || loggedInUser === void 0 ? void 0 : loggedInUser.phoneNumber));
    console.log("Password: ".concat(loggedInUser === null || loggedInUser === void 0 ? void 0 : loggedInUser.password));
    console.log("Gender: ".concat(loggedInUser === null || loggedInUser === void 0 ? void 0 : loggedInUser.gender));
    loggedInMenu();
};
