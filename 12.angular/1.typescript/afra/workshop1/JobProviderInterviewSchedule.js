...
var JobProvider = /** @class */ (function () {
    ...
    JobProvider.prototype.selectOption = function (input) {
        switch (input) {
            ...
            case '2':
                ...
                break;
            case '3':
                this.showScheduledInterviewList();
                break;
            case '0':
                exitProgram = true;
                break;
    ...
    JobProvider.prototype.showScheduledInterviewList = function () {
        console.log("\n--------------------------------------------------Scheduled Interview List-----------------------------------------------\n");
        interviewList.forEach(function (list) {
            console.log("jobtitle:" + list.jobTitle + "\ndate:" + list.dateOfInterview + "\ntime:" + list.time + "\nmode:" + list.modeOfInterview);
        });
        console.log("\n------------------------------------------------------------------------------------------------------------\n");
    };
