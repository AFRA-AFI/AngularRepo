...
var Authentication = /** @class */ (function () {
    ...
    Authentication.prototype.showMenuItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var jobObject, dashboardObject, jobseekerObject, option, _a, CName, companyName, opt;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        console.log("3. Search Jobs By Company or Title");
                    ...
                    case 5:
                        CName = _b.sent();
                        jobseekerObject.searchByCompany(CName);
                        this.showContinuePrompt = true;
                        return [3 /*break*/, 10];
                    case 6: return [4 /*yield*/, this.askQuestion("Enter the company name: ")];
                    case 7:
                        companyName = _b.sent();
                    ...
                    case 10:
                        if (!this.showContinuePrompt) return [3 /*break*/, 12];
